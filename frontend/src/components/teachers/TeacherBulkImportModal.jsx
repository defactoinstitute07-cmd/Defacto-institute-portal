...
const TeacherBulkImportModal = ({
    ...
    return (
        <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
            <div className="modal" style={{ maxWidth: 680, width: '95vw' }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, position: 'relative', zIndex: 1 }}>
                        ...
                        <div>
                            <h3 style={{ margin: 0, fontSize: '1.2rem', fontWeight: 900, letterSpacing: '-0.02em' }}>BULK IMPORT FACULTY</h3>
                            <p style={{ margin: 0, fontSize: '0.8rem', opacity: 0.8, fontWeight: 500 }}>Upload Excel or CSV file to batch register teachers</p>
                        </div>
                    </div>
                ...
                <div className="modal-body" style={{ maxHeight: '75vh', overflowY: 'auto', padding: '32px' }}>
                    ...
                    <div style={{ marginTop: 24, padding: '16px 20px', background: '#ecfdf5', borderRadius: '4px', border: '1px solid #d1fae5', display: 'flex', gap: 12, alignItems: 'center' }}>
                        ...
                        <div style={{ fontSize: '0.8rem', color: '#065f46', fontWeight: 600, lineHeight: 1.5 }}>
                            All imported faculty will be assigned the default password <strong>teacher@123</strong>. Ensure headers match exactly.
                        </div>
                    </div>
            ...
            {
                bulkFile && !err && !bulkResults && (
                    <div style={{ padding: '0 32px 20px' }}>
                        <div style={{ padding: '20px', background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '4px' }}>
                            <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 900, color: '#475569', marginBottom: 8, textTransform: 'uppercase' }}>
                            ...
                            <input
                                ...
                                style={{
                                    width: '100%', padding: '12px 16px', borderRadius: '4px', border: '1px solid #cbd5e1',
                                    fontSize: '0.9rem', outline: 'none', transition: 'border-color 0.2s'
                                }}
                            />
                            <p style={{ margin: '8px 0 0', fontSize: '0.7rem', color: '#64748b' }}>
                                Please provide your admin password to authorize this bulk import operation.
                            </p>
                        </div>
                    </div>
                )
            ...
            <div style={{ padding: '20px 32px', borderTop: '1px solid #e2e8f0', background: '#f8fafc', display: 'flex', justifyContent: 'flex-end', gap: 12 }}>
                ...
                <button
                    type="button"
                    disabled={!bulkFile || saving || (bulkFile && !err && !bulkResults && !adminPassword) || bulkResults}
                    onClick={() => onConfirm(adminPassword)}
                    style={{
                        padding: '10px 32px', background: (!bulkFile || saving || (bulkFile && !err && !bulkResults && !adminPassword) || bulkResults) ? '#94a3b8' : '#059669', color: '#fff',
...
export default TeacherBulkImportModal;
