                ...
                <div style={{ flex: 1, overflowY: 'auto' }}>
                    ...
                    <form onSubmit={handleSubmit} style={{ background: '#fff', border: `1.5px solid ${borderColor}`, borderRadius: sharpRadius, padding: '40px' }}>
                        ...
                        {tab === 0 && (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
                                ...
                                <div className="mf-row">
                                    <div className="mf" style={{ flex: 2 }}><label>FULL NAME *</label><input style={{ borderRadius: sharpRadius }} value={name} onChange={e => setName(e.target.value)} placeholder="e.g. John Doe" required /></div>
                                    <div className="mf"><label>GENDER</label>
                                        <select style={{ borderRadius: sharpRadius }} value={gender} onChange={e => setGender(e.target.value)}>
                                ...
                                <div className="mf-row">
                                    <div className="mf"><label>DATE OF BIRTH</label><input type="date" style={{ borderRadius: sharpRadius }} value={dob} onChange={e => setDob(e.target.value)} /></div>
                                    <div className="mf"><label>OFFICIAL EMAIL</label><input type="email" style={{ borderRadius: sharpRadius }} value={email} onChange={e => setEmail(e.target.value)} placeholder="faculty@inst.edu" /></div>
                                </div>

                                <div className="mf-row">
                                    <div className="mf"><label>PHONE NUMBER *</label><input style={{ borderRadius: sharpRadius }} value={phone} onChange={e => setPhone(e.target.value)} required /></div>
                                    <div className="mf"><label>EMERGENCY CONTACT</label><input style={{ borderRadius: sharpRadius }} value={altPhone} onChange={e => setAltPhone(e.target.value)} /></div>
                                </div>

                                <div className="mf"><label>RESIDENCE ADDRESS (CURRENT)</label><textarea style={{ borderRadius: sharpRadius, minHeight: 80, padding: 12 }} value={currentAddress} onChange={e => setCurrentAddress(e.target.value)} /></div>
                                <div className="mf"><label>PERMANENT ADDRESS (AS PER ID)</label><textarea style={{ borderRadius: sharpRadius, minHeight: 80, padding: 12 }} value={permanentAddress} onChange={e => setPermanentAddress(e.target.value)} /></div>
                            </div>
                        )}
                        ...
                        {tab === 1 && (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
                                <div className="mf-row">
                                    <div className="mf"><label>DEPARTMENT</label><input style={{ borderRadius: sharpRadius }} value={department} onChange={e => setDepartment(e.target.value)} placeholder="e.g. Science, Arts" /></div>
                                    <div className="mf"><label>DESIGNATION</label><input style={{ borderRadius: sharpRadius }} value={designation} onChange={e => setDesignation(e.target.value)} placeholder="e.g. Senior Teacher" /></div>
                                </div>

                                <div className="mf"><label>ACADEMIC QUALIFICATIONS</label><input style={{ borderRadius: sharpRadius }} value={qualifications} onChange={e => setQualifications(e.target.value)} placeholder="e.g. Ph.D, M.Sc (Physics)" /></div>

                                <div className="mf-row">
                                    <div className="mf"><label>TOTAL EXPERIENCE</label><input style={{ borderRadius: sharpRadius }} value={experience} onChange={e => setExperience(e.target.value)} placeholder="e.g. 5 Years" /></div>
                                    <div className="mf"><label>DATE OF JOINING</label><input type="date" style={{ borderRadius: sharpRadius }} value={joiningDate} onChange={e => setJoiningDate(e.target.value)} /></div>
                                </div>
                                ...
                                <div className="mf-row">
                                    <div className="mf" style={{ position: 'relative' }}>
                                        ...
                                        <div style={{ position: 'relative' }}>
                                            ...
                                            <input type="number" style={{ borderRadius: sharpRadius, paddingLeft: 36 }} value={salary} onChange={e => setSalary(e.target.value)} placeholder="0.00" />
                                        </div>
                                    </div>
                                ...
                                <div className="mf-row">
                                    <div className="mf">
                                        ...
                                        <div style={{ position: 'relative' }}>
                                            ...
                                            <input value={regNo || 'TCH-PENDING'} disabled style={{ paddingLeft: 36, background: '#f8fafc', fontWeight: 800, borderRadius: sharpRadius, color: primaryColor }} />
                                        </div>
                                    </div>
                                    <div className="mf">
                                        <label>SYSTEM ROLE</label>
                                        <select style={{ borderRadius: sharpRadius, fontWeight: 700 }} value={systemRole} onChange={e => setSystemRole(e.target.value)}>
                                ...
                                <div className="mf-row">
                                    <div className="mf">
                                        ...
                                        <div style={{ position: 'relative' }}>
                                            ...
                                            <input type={showTpwd ? 'text' : 'password'} value={teacherPwd} onChange={e => setTeacherPwd(e.target.value)} placeholder={mode === 'edit' ? '••••••••' : 'Default: TCH@123'} style={{ paddingLeft: 36, borderRadius: sharpRadius }} />
                                    ...
                                    <div className="mf">
                                        ...
                                        <select style={{ borderRadius: sharpRadius, fontWeight: 700 }} value={status} onChange={e => setStatus(e.target.value)}>
